...
<body>
<form id="form1" name="form1" method="post" action="balanceequanry_code.jsp">
  <table width="1082" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="868" valign="top" bgcolor="#8EB8DE"><p>&nbsp;</p>
        ...
        <tr>
          <td colspan="2" align="center"><h1>Balance Enquiry</h1></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td><input type="submit" name="button" id="button" value="Submit" />
            Your Balance :<%=session.getAttribute("amt")%>  </td>
        </tr>
      </table>
      <p>&nbsp;</p></td>
    </tr>
