...
<body>
<form id="form1" name="form1" method="post" action="newcustomer_user_code.jsp">
  <table width="1082" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td bgcolor="#EEEEEE"><ul id="MenuBar2" class="MenuBarHorizontal">
        ...
        <li><a href="balanceequanry.jsp">Balance Equary</a></li>
    ...
    <tr>
      <td width="868" valign="top" bgcolor="#FFFFFF"><p>&nbsp;</p>
        ...
        <tr>
          <td width="189" bgcolor="#FFFFFF">Cusomer Name</td>
